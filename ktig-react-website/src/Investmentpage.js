...
function Investmentpage (){
    ...
    <div class="container-fluid ktig_services_page bg-breadcrumb">
        <div class="container text-center py-5" style={{maxWidth:'9000px'}}>
            ...
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Our Investors</h4>
        </div>
    </div>
    {/* <!-- Header End --> */}
    ...
    <div class="container-fluid ktig_services_page it_solution_details_1 overflow-hidden py-5">
        <div class="container">
            <div class="row col-xl-9 m-auto g-5">
                <div class="text-center mt-0 mx-auto wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth:'800px'}}>
                    <h1 class="title display-3 text-capitalize text-white" style={{ fontSize: 'xx-large' }}>Our Investors</h1>

                </div>
                <div class="col-xl-6 border_image_block wow fadeInRight" data-wow-delay="0.2s">
                    <div class="about-img service_img h-100">
                        <div class=""></div>
                        <img src="assets/img/blog/it_sector.jpg" class="img-fluid w-100 m-auto d-block"  alt="service" style={{borderRadius:"0rem",maxWidth:"100%"}}/>
                        <h>Add the name</h>
                    </div>
                </div>
                <div class="col-xl-6 border_image_block wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="about-item">
                    <h style={{fontSize:'large',fontWeight:'600px', color:'white'}}>Title 1</h>

                        <p class="mb-4 text-white text-left" style={{marginTop:'1rem',fontFamily:'poppins'}}>BNR Cogniitec is a leader in the IT industry. With
                            innovative solutions such as enterprise-level digital marketing projects, cloud computing
                            services, AI/ML implementations, and custom software development.
                        </p>
                    </div>
                </div>
