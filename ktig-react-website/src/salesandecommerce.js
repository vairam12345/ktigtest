...
function saleEcommerce (){
    ...
    <div class="container-fluid ktig_services_page sale_details_1 overflow-hidden py-5">
        <div class="container">
            <div class="row col-xl-9 m-auto g-5">
                <div class="text-center mt-0 mx-auto wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth:'800px'}}>
                    <h1 class="display-3 text-white">Sales and E-commerce</h1>
                    <p class="mb-5 text-white text-center ">We provide all solutions for your business</p>
                </div>
                <div class="col-xl-6 wow border_image_block fadeInRight" data-wow-delay="0.2s">
                    <div class="about-img service_img h-100">
                        <div class=""></div>
                        <img src="assets/img/blog/sales.jpg" class="img-fluid w-100 m-auto d-block"  alt="service" style={{borderRadius:'8.2rem'}} />
                    </div>
                </div>
                <div class="col-xl-6 wow border_image_block fadeInLeft" data-wow-delay="0.2s">
                    <div class="about-item">

                        <p class="mb-4 text-white text-left" style={{marginTop:'5rem',fontFamily:'poppins'}}>The sales and e-commerce ,team provides integrated payment
                            systems, digital marketplace solutions, and end-to-end e-commerce platform development.
                        </p>
                    </div>
                </div>
