            ...
            <div class="row g-5">
                ...
                <div class="col-xl-9 m-auto wow fadeInRight" data-wow-delay="0.2s">
                    ...
                    <div class="about-item text-center">
                        ...
                        <h1 class="mb-4 text-white">IT/TES Services


                        </h1>
                        <p class="text-white text-left" >Empower your business with our comprehensive IT and Technology Enabled Services that drive digital transformation and operational excellence. Our solutions encompass custom software development, cloud computing, AI/ML implementation, and enterprise system integration. We ensure seamless technology adoption while maximizing efficiency and reducing operational costs.



                        </p>
                        <p class="text-white text-left">Our dedicated team delivers end-to-end IT solutions, from requirement analysis to implementation and support. We specialize in developing scalable applications, maintaining critical systems, and providing technical support services that keep your business running smoothly. Our focus on innovation and quality ensures that your technology infrastructure remains cutting-edge and reliable.
