        ...
        <div class="container">
            <div class="row col-xl-9 m-auto g-5">
                <div class="text-center mt-0 mx-auto wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth:'800px'}}>
                    <h1 class="display-3 text-capitalize text-white">IT Solutions</h1>
                    <p class="mb-5 text-white text-center ">Business Development</p>
                </div>
                <div class="col-xl-6 border_image_block wow fadeInRight" data-wow-delay="0.2s">
                    <div class="about-img service_img h-100">
                        <div class=""></div>
                        <img src="assets/img/blog/it_sector.jpg" class="img-fluid w-100 m-auto d-block"  alt="service" style={{borderRadius:"8rem",maxWidth:"100%"}}/>
                    </div>
                </div>
                <div class="col-xl-6 border_image_block wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="about-item">

                        <p class="mb-4 text-white text-left" style={{marginTop:'5rem',fontFamily:'poppins'}}>BNR Cogniitec is a leader in the IT industry. With
