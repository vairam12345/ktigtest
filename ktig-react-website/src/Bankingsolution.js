...
function Bankingpage(){
    ...
    <div class="container-fluid ktig_services_page bank_details_1 overflow-hidden py-5">
        <div class="container">
            <div class="row col-xl-9  m-auto g-5">
                <div class="text-center mt-0 mx-auto wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth:'800px'}}>
                    <h1 class="display-3 text-capitalize text-white">Banking Solutions</h1>
                    <p class="mb-5 text-white text-center"style={{fontWeight:'bold'}}>For all your need</p>
                </div>

                <div class="col-xl-6 border_image_block  wow fadeInRight" data-wow-delay="0.2s">
                    <div class="about-img service_img h-100">
                        <div class=""></div>
                        <img src="assets/img/blog/banking.jpg" class="img-fluid w-100 m-auto d-block" alt="service" style={{borderRadius:'100px'}} />
                    </div>
                </div>
                <div class="col-xl-6 border_image_block wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="about-item">

                        <p class="mb-4 text-white text-left" style={{fontFamily:'poppins',marginTop:'5rem'}}>The Banking & Finance Sector provides full digital banking
                            solutions, payment gateway integrations, financial software development, and automated
                            lending platforms, as well as wealth management consultancy and investment advice services.
                        </p>
                    </div>
                </div>
