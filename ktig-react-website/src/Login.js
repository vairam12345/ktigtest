...
//       const apiUrl =
//         formType === "form1"
//           ? "http://3.110.119.143:8081/api/images/upload"
//           : "http://3.110.119.143:8081/api/blogimages/upload";
...
//             </button>
//             <img
//                 src={`http://3.110.119.143:8081${form1Events[currentIndex1].image}`} 
...
//             </button>
//             <img
//                 src={`http://3.110.119.143:8081${form2Events[currentIndex2].image}`} // Adjust to full URL
//               style={{ width: "60%", height: "auto", borderRadius: "8px" }}
//             />
//             <h3 style={{ color: "white", marginTop: "10px" }}>
...
//             </button>
//             <img
//               src={`http://3.110.119.143:8081${form2Events[currentIndex2].image}`}
//               style={{ width: "60%", height: "auto", borderRadius: "8px" }}
//             />
//             <h3 style={{ color: "white" }}>
//               {form2Events[currentIndex2].title}
...
const handlePrevSlide = (totalSlides) => {
  ...
  useEffect(() => {
    ...
    axios.get(" http://3.110.119.143:8081/api/images/images").then((response) => {
      setForm1Events(response.data);
    });
    axios.get("http://3.110.119.143:8081/api/blogimages/images").then((response) => {
  ...
  const handleDelete = (formType, id) => {
    const apiUrl =
      formType === "form1"  
        ? `http://3.110.119.143:8081/api/images/images/${id}`
        : `http://3.110.119.143:8081/api/blogimages/images/${id}`;
  ...
  return (
    ...
    //           <div key={event._id}>
    //         <img src={`http://3.110.119.143:8081${event.imagePath}`}   style={{ width: "30%", height: "auto", borderRadius: "8px" }} />
    //       <p>{event.title}</p>
      ...
      {form1Events.length > 0 ? (
        form1Events.map((event) => (
          <div key={event._id} className="card">
            <img 
              src={`http://3.110.119.143:8081${event.imagePath}`} 
              alt={event.title} 
