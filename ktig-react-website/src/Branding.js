            ...
            <div class="row g-5">
                ...
                <div class="col-xl-9 m-auto wow fadeInRight" data-wow-delay="0.2s">
                    ...
                    <div class="about-item text-center">
                        ...
                        <h1 class="mb-4 text-white">Branding</h1>
                        <p class="text-white text-left" > Transform your business identity with our strategic branding solutions that create lasting impressions and build strong market presence. Our branding experts craft unique brand stories, visual identities, and communication strategies that resonate with your target audience. We develop comprehensive brand guidelines that ensure consistency across all platforms and touchpoints.

                        </p>
                        <p class="text-white text-left">From logo design to brand voice development, we create cohesive brand experiences that differentiate your business in competitive markets. Our branding solutions encompass market research, competitor analysis, brand positioning, and identity development, helping you build a strong, recognizable brand that drives customer loyalty and business growth.</p>
                    </div>
