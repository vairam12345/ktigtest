            ...
            <div class="row g-5">
                ...
                <div class="col-xl-9 m-auto wow fadeInRight" data-wow-delay="0.2s">
                    ...
                    <div class="about-item text-center">
                        ...
                        <h1 class="mb-4 text-white">Business Development</h1>
                        <p class="text-white text-left" > Our business development services focus on creating sustainable
                            growth
                            strategies tailored to your organization's unique needs. We identify market opportunities,
                            optimize business processes, and develop strategic partnerships that drive expansion and
                            revenue growth. Our expert team conducts thorough market analysis and competitor assessment
                            to position your business for success.

                        </p>
                        <p class="text-white text-left">Through our comprehensive approach, we help businesses
                            streamline
                            operations, enhance productivity, and capture new market segments. Our services include
                            strategic planning, market entry strategies, business model optimization, and performance
                            monitoring. We ensure measurable outcomes through data-driven decisions and agile
