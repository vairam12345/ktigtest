            ...
            <div class="row group_contact g-5">
                <div class="col-lg-10 m-auto h-100 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="text-center mx-auto py-5" style={{maxWidth:'800px'}}>
                        ...
                        <div class="text-center col-lg-4 mx-auto py-5" style={{maxWidth:'800px'}}>
                            <h4 class="display-3 text-white text-capitalize mb-3" style={{fontWeight:'normal'}}>Corporate
                                Office</h4>
                            <p class="mb-0 text-white" style={{fontFamily:'poppins'}}>KTIG<b /> Tower 53-2, second Floor, <br />2nd Cross,
                                MKP Colony, Ganapathy,
                                Coimbatore - 641006 <br />TamilNadu, India
                            </p>
                            
                        </div>
                        <div class="text-center col-lg-4 mx-auto" style={{maxWidth:'800px',fontFamily:'poppins'}}>

                            <h4 class="mb-0 text-white">Business Hours</h4>
                            <p class="mb-3 text-white"> Monday to Saturday: <br />
                                9:30 AM - 6:30 PM<br />
                                Sunday: Closed
                            </p>
                        </div>
