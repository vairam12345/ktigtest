        ...
        <div class="row g-5">
            <div class="col-xl-9 m-auto wow fadeInRight" data-wow-delay="0.2s">
                <div class="about-item text-left"> 
                    ...
                    <h1 class="mb-5 text-white text-left " style={{marginLeft:'8rem'}}>Technical Training Programs</h1> 
                    <h4 class="mb-4 text-white text-left custom-width" >Web Application Development</h4>
                    <p class="text-white text-left">Master the art of modern web development with our comprehensive
                        training in advanced frameworks and technologies. Our hands-on programs cover frontend and backend
                        development, database management, and deployment strategies. Training includes practical projects, 
                        industry-standard coding practices, and real-world application development scenarios that prepare you for 
                        professional web development roles.</p>

                    <h4 class="mb-4 text-white text-left custom-width">Mobile Application Development</h4>
                    <p class="text-white text-left">Dive into the world of mobile app creation with our specialized courses 
                        covering both Android and iOS development. Learn to build responsive, user-friendly applications 
                        using the latest tools and frameworks. Our training combines theoretical knowledge with practical 
                        app development projects, ensuring you gain the skills needed to create market-ready mobile applications.</p>

                    <h4 class="mb-4 text-white text-left custom-width">Artificial Intelligence & Machine Learning</h4>
                    <p class="text-white text-left">Transform your career with our cutting-edge AI/ML training programs. 
                        From basic algorithms to advanced deep learning models, our courses cover the complete spectrum of AI 
                        technologies. Learn data analysis, model development, and practical implementation of AI solutions 
                        through real-world case studies and hands-on projects.</p>

                    <h4 class="mb-4 text-white text-left custom-width">Digital Marketing Excellence</h4>
                    <p class="text-white text-left">Master comprehensive digital marketing strategies through our practical 
                        training programs. Learn SEO, social media marketing, content strategy, email marketing, and analytics. 
                        Our courses include live campaign management, tool usage, and performance tracking, preparing you for 
                        successful digital marketing roles.</p>
            ...
            <div class="row col-lg-11 m-auto g-5">
                ...
                {/* <div class="col-md-6 col-lg-6 col-xl-2">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="Goalandrules" class="font-s"><i
                                class="fas fa-angle-right me-2"></i>Technical Training</a>
                        <a href="Goalandrules" class="font-s"><i class="fas fa-angle-right me-2"></i>
