            ...
            <div class="row g-5">
                ...
                <div class="col-xl-9 m-auto wow fadeInRight" data-wow-delay="0.2s">
                    ...
                    <div class="about-item text-center">
                        ...
                        <h1 class="mb-4 text-white">Banking and Finance
                        </h1>
                        <p class="text-white text-left" > Our banking and finance solutions leverage cutting-edge technology to streamline financial operations and enhance service delivery. We provide comprehensive digital banking platforms, payment solutions, and financial management systems that enable efficient transactions and robust security. Our solutions help financial institutions modernize their operations while ensuring regulatory compliance.



                        </p>
                        <p class="text-white text-left">We specialize in developing customized financial products, risk management systems, and automated lending platforms. Our expertise extends to wealth management solutions, investment advisory services, and microfinance systems, all designed to maximize operational efficiency and customer satisfaction while maintaining the highest security standards.</p>
                    </div>
