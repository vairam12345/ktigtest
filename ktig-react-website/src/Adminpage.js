...
//       axios
//         .post("http://3.110.119.143:8081/api/images/upload", formDataToSend)
//         .then((response) => {
//           onSubmit(formType, {
...
//   useEffect(() => {
//     axios
//       .get("http://3.110.119.143:8081/api/images/images")
//       .then((response) => {
...
//     axios
//       .get("http://3.110.119.143:8081/api/blogimages/images")
//       .then((response) => {
//         const events = response.data; // assuming data contains event list
//         setForm2Events(events.filter(event => event.type === 'form2'));
//       })
...
//               <img
//                 // src={form1Events[currentIndex1].image}
//                 src={`http://3.110.119.143:8081${form1Events[currentIndex1].image}`} // Adjust to full URL
