...
function Nonitsolution (){
    ...
    <div class="container-fluid ktig_services_page non_it_details_1 overflow-hidden py-5">
        <div class="container">
            <div class="row col-xl-9 m-auto g-5">
                <div class="text-center mt-0 mx-auto wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth:'800px'}}>
                    <h1 class="display-3 text-capitalize text-white">Non IT Solutions</h1>
                    <p class="mb-5 text-white text-center ">We happy to join with us</p>
                </div>
                <div class="col-xl-6 border_image_block wow fadeInRight" data-wow-delay="0.2s">
                    <div class="about-item">

                        <p class="mb-4 text-white text-right" style={{fontFamily:'poppins',marginTop:'5rem'}}>The non-IT division focuses on business process
                            outsourcing, document digitization, data management services,customer support and technical
                            support solutions.
                        </p>
                    </div>
                </div>
                <div class="col-xl-6 border_image_block wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="about-img service_img h-100">
                        <div class=""></div>
                        <img src="assets/img/blog/none_it.jpg" class="img-fluid w-100 m-auto d-block"  alt="service" style={{borderRadius:'5rem'}}/>
                    </div>
                </div>
            </div>
        </div>
