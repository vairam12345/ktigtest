const Payment = require("../../models/KtnlformModels/OutwardformModel");

// Create a new payment
const createKTNLOutward = async (req, res) => {
  try {
...
// Get all payments
const getKTNLOutwards = async (req, res) => {
  try {
...
const updateKTNLOutward = async (req, res) => {
  try {
    const { id } = req.params;
    const { paymentMethod, amount, authorizedPerson, approved, description } = req.body;
...
const deleteKTNLOutward = async (req, res) => {
  try {
    const { id } = req.params;
