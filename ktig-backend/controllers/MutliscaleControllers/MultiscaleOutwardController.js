const Payment = require("../../models/MutilscaleModels/OutwardModel");

// Create a new payment
const createMultiscaleOutward = async (req, res) => {
  try { 
...
// Get all payments
const getMultiscaleOutward = async (req, res) => {
  try {
...
const updateMultiscaleOutward = async (req, res) => {
  try {
    const { id } = req.params;
    const { paymentMethod, amount, authorizedPerson, approved, description } = req.body;
...
const deleteMultiscaleOutward = async (req, res) => {
  try {
    const { id } = req.params;
...
module.exports = {
  createMultiscaleOutward,
  getMultiscaleOutward,
  updateMultiscaleOutward,
  deleteMultiscaleOutward,
};
