const Payment = require("../../models/MutilscaleModels/InwardModel");

// Create a new payment
const createMultiscaleInward = async (req, res) => {
  try { 
...
// Get all payments
const getMultiscaleInward = async (req, res) => {
  try {
...
const updateMultiscaleInward = async (req, res) => {
  try {
    const { id } = req.params;
    const { paymentMethod, amount, authorizedPerson, approved, description } = req.body;
...
const deleteMultiscaleInward = async (req, res) => {
  try {
    const { id } = req.params;
...
module.exports = {
  createMultiscaleInward,
  getMultiscaleInward,
  updateMultiscaleInward,
  deleteMultiscaleInward,
};
