const Payment = require("../../models/KtmcModels/KtmcInwardModel");

// Create a new payment
const createKtmcInward = async (req, res) => {
  try { 
...
// Get all payments
const getKtmcInward = async (req, res) => {
  try {
...
const updateKtmcInward = async (req, res) => {
  try {
    const { id } = req.params;
    const { paymentMethod, amount, authorizedPerson, approved, description } = req.body;
...
const deleteKtmcInward = async (req, res) => {
  try {
    const { id } = req.params;
