const Payment = require("../../models/KtmcModels/KtmciutwardModel");

// Create a new payment
const createKtmcOutward = async (req, res) => {
  try { 
...
// Get all payments
const getKtmcOutward = async (req, res) => {
  try {
...
const updateKtmcOutward = async (req, res) => {
  try {
    const { id } = req.params;
    const { paymentMethod, amount, authorizedPerson, approved, description } = req.body;
...
const deleteKtmcOutward = async (req, res) => {
  try {
    const { id } = req.params;
