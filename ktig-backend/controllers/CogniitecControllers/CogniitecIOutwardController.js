const Payment = require("../../models/CogniitecModels/Outwardform");

// Create a new payment
const createCogniitecOutward = async (req, res) => {
  try { 
...
// Get all payments
const getCogniitecOutwards = async (req, res) => {
  try {
...
const updateCogniitecOutward = async (req, res) => {
  try {
    const { id } = req.params;
    const { paymentMethod, amount, authorizedPerson, approved, description } = req.body;
...
const deleteCogniitecOutward = async (req, res) => {
  try {
    const { id } = req.params;
...
module.exports = {
  createCogniitecOutward,
  getCogniitecOutwards,
  updateCogniitecOutward,
  deleteCogniitecOutward,
};
